...
Отчёт.Вариант №18 Сервис оборудования аудиторий (Room Equipment Service)
Сущность: Equipment
...
|----------|-----------|----------------|-----|-------------|----------------------|
| name | Название оборудования (например, "проектор") | Да | string | 2..100 символов, уникально | нет |
| description | Описание характеристик | Нет | string | до 500 символов | null |
| equipment_type | Тип (техника, мебель, инструмент) | Да | enum | tech, furniture, tool | tech |
...
|----------|-----------|-----|----------|
|`equipment_type | Фильтр по типу | enum | tech, furniture, tool |
| is_portable | Фильтр по переносимости | boolean | true/false |
| power_required | Фильтр по питанию | boolean | true/false |
| is_active | Активное или удалённое | boolean | по умолчанию true |
| search | Поиск по названию | string | частичное совпадение |
| limit | Лимит записей | integer | 1..100, по умолч. 20 |
| offset | Смещение | integer | >=0, по умолч. 0 |
